{
  ...
  class Item {
    constructor(el) {
      ...
      this.DOM = { el: el };
      // the inner image
      this.DOM.parallaxItem = this.DOM.el.querySelector(
        '[data-parallax=true]'
      );
      this.renderedStyles = {
        ...
        innerTranslationY: {
          ...
          setValue: () => {
            const maxValue = this.renderedStyles
              .innerTranslationY.maxValue;
    ...
    render() {
      ...
      for (const key in this.renderedStyles) {
        this.renderedStyles[
          key
        ].current = this.renderedStyles[key].setValue();
    ...
    layout() {
      ...
      if (this.DOM.parallaxItem != null) {
        this.DOM.parallaxItem.style.transform = `translate3d(0,${this.renderedStyles.innerTranslationY.previous}px,0)`;
      }
    }
  }
  ...
  class SmoothScroll {
    constructor() {
      ...
      this.items = [];
      [
        ...this.DOM.main.querySelectorAll('section'),
    ...
    style() {
      ...
      this.DOM.main.style.width = this.DOM.main.style.height =
        '100%';
    ...
    render() {
      ...
      for (const item of this.items) {
        ...
        if (item.isVisible) {
          item.render();
          item.DOM.el.classList.add('active');
        } else {
